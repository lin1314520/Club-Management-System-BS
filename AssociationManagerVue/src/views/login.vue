                ...
                <el-row :gutter="15">
                    <el-col :span="12">
                        <el-form-item label="用户账号">
                            <el-input v-model="usersForm.username" placeholder="请输入账号…" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="用户密码">
                            <el-input v-model="usersForm.password" type="password" placeholder="请输入密码…"
                ...
                <el-row :gutter="15">
                    <el-col :span="12">
                        <el-form-item label="真实姓名">
                            <el-input v-model="usersForm.realName" placeholder="请输入姓名…" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="联系电话">
                            <el-input v-model="usersForm.phone" placeholder="请输入电话…" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="15">
                    <el-col :span="24">
                        <el-form-item label="邮箱">
                            <el-input v-model="usersForm.email" placeholder="请输入邮箱…" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
...
export default {
    ...
    methods: {
        ...
        addInfo() {
            ...
            if (this.usersForm.realName.trim() == '') {
                this.$message({
                    message: "请填写姓名",
                    type: "warning",
                });
