...
export default {
    ...
    methods: {
        ...
        getPageInfo(pageIndex, pageSize) {
            getPageTeams(pageIndex, pageSize, this.qryForm.clubName, this.qryForm.typeId).then(
                (resp) => {
    ...
    mounted() {
        ...
        getLoginUser(this.$store.state.token).then((resp) => {
            ...
            this.$store.state.userInfo = resp.data; // Store user info for ID usage
        });
    },
};
</script>