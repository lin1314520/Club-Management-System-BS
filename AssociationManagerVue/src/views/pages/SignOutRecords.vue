                ...
                <el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
                    ...
                    <el-table-column align="center" label="签退状态">
                        <template slot-scope="scope">
                            <el-tag type="success" v-if="scope.row.status == 1">已签退</el-tag>
                            <el-tag type="danger" v-if="scope.row.status == 0">未签退</el-tag>
                        </template>
                    </el-table-column>
...
<script>
import { getLoginUser, getPageSignOutRecords } from "../../api";
...
export default {
    ...
    methods: {
        ...
        getPageInfo(pageIndex, pageSize) {
            ...
            getPageSignOutRecords(pageIndex, pageSize, this.qryForm.activityId, uId).then((resp) => {
