        ...
        <el-dialog title="添加信息" width="600px" :visible.sync="showAddFlag">
            <el-form label-width="90px" :model="teamTypesForm">
                <el-form-item label="类型名称">
                    <el-input
                        v-model="teamTypesForm.typeName"
                        placeholder="请输入类型名称…"
                        autocomplete="off"
                    ></el-input>
                </el-form-item>
                <el-form-item label="类型描述">
                    <el-input
                        v-model="teamTypesForm.description"
                        type="textarea"
                        placeholder="请输入类型描述…"
                        autocomplete="off"
                    ></el-input>
...
export default {
    ...
    methods: {
        ...
        getPageLikeInfo() {
            getPageTeamTypes(1, this.pageSize, this.qryForm.typeName).then(
                (resp) => {
                    this.pageInfos = resp.data.data;
                    this.pageIndex = resp.data.pageIndex;
                    this.pageSize = resp.data.pageSize;
        ...
        handleSizeChange(pageSize) {
            this.getPageInfo(this.pageIndex, pageSize, this.qryForm.typeName);
        },
        handleCurrentChange(pageIndex) {
            this.getPageInfo(pageIndex, this.pageSize, this.qryForm.typeName);
        },
        initForm() {
            this.teamTypesForm = {
                id: "",
